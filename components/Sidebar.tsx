...
const ICONS = {
  ...
  alvo: <svg {...S}><circle cx="12" cy="12" r="8.5" /><circle cx="12" cy="12" r="4.8" /><circle cx="12" cy="12" r="1.3" fill="currentColor" /></svg>,
...
/** Barra inferior do celular: os atalhos mais usados + "Mais". */
const ABAS = [
  ['/', 'Painel', ICONS.home],
